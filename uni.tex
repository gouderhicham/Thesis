...
\begin{enumerate}
	...
	\item \textbf{Design and Development}
	      \begin{itemize}
		      ...
		      \item Store and manage data using \textbf{Firebase and MySQL}.
	      \end{itemize}
	...
	\item \textbf{Deployment and Future Enhancements}
	      \begin{itemize}
		      ...
		      \item Plan for \textbf{future updates}, including:
		            \begin{itemize}
			            \item \textbf{AI-based Medicine Recommendations }
			            \item \textbf{Ability To Book Appointments From The App }
			            \item \textbf{List of Generic Medications And their Prices }
		            \end{itemize}
	      \end{itemize}
\end{enumerate}
...
\vspace{0.6cm}
\begin{center}
	\includegraphics[width=\textwidth]{images/patientCAS.pdf} % Replace "diagram.pdf" with your actual filename
\end{center}
\vspace{-0.35cm}
\begin{center}
		...
		\begin{call}{U}{Login(username, password)}{S}{}
			...
			\begin{sdblock}{alt}{Are credentials valid?}
				...
				\begin{sdblock}{option}{No}
					\mess{S}{Login Faild Try Login Again}{U}
				\end{sdblock}
			\end{sdblock}
		\end{call}
...
\begin{sequencediagram}
    ...
    \begin{sdblock}{Add/Delete Specialization}{}
        ...
        \mess{A}{Update Success}{Ad}
        
    \end{sdblock}

    % Database sends update notification to interface
    \postlevel
    \vspace{0.6cm}
    \prelevel
    \mess{DB}{Specializations Updated}{A}
\end{sequencediagram}
...
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/1.jpg}}
			\centering \small User Login
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/2.jpg}}
			\centering \small Home Page 1
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/3.jpg}}
			\centering \small Home Page 2
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/11.jpg}}
			\centering \small Clinics Map Page
		\end{minipage} \\
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/12.jpg}}
			\centering \small Clinic Search
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/13.jpg}}
			\centering \small Clinic GPS Tracking
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/5.jpg}}
			\centering \small Clinc Page 1
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/6.jpg}}
			\centering \small Clinic Page 2
		\end{minipage} \\
	\end{tabular}
\end{center}
\newpage
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/7.jpg}}
			\centering \small Clinic Doctors List
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/4.jpg}}
			\centering \small Doctor Page 1
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/8.jpg}}
			\centering \small Doctor Page 2
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/10.jpg}}
			\centering \small Clinics Browser
		\end{minipage} \\
	\end{tabular}
\end{center}
\newpage
\begin{center}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/user/9.jpg}}
			\centering \small Side Menu
		\end{minipage} 
\end{center}
\newpage
...
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/1.jpg}}
			\centering \small Home 
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/9.jpg}}
			\centering \small Unregistred Clinics
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/10.jpg}}
			\centering \small Unregistred Clinic Details
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/3.jpg}}
			\centering \small Registered Clinics
		\end{minipage} \\
	\end{tabular}
\end{center}
\newpage
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/7.jpg}}
			\centering \small Specialties Page
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/8.jpg}}
			\centering \small Add Specialty
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/6.jpg}}
			\centering \small Reported Clinics
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/4.jpg}}
			\centering \small Reported Clinic Details 1
		\end{minipage} \\
	\end{tabular}
\end{center}
\newpage
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/5.jpg}}
			\centering \small Reported Clinic Details 2
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/admin/2.jpg}}
			\centering \small Doctors List
		\end{minipage} 
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/2.jpg}}
			\centering \small Clinic Login
		\end{minipage}     &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/3.jpg}}
			\centering \small Clinic Registration 1
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/4.jpg}}
			\centering \small Clinic Registration 2
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/1.jpg}}
			\centering \small Clinic Sign In Fail
		\end{minipage}     \\
	\end{tabular}
\end{center}
\newpage
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/5.jpg}}
			\centering \small Clinic Doctors List
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/6.jpg}}
			\centering \small Add Doctor
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/8.jpg}}
			\centering \small Clinic Page 1
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/9.jpg}}
			\centering \small Clinic Page 2
		\end{minipage} \\
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/11.jpg}}
			\centering \small Edit Schedule
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/10.jpg}}
			\centering \small Language Selection
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/clinic/7.jpg}}
			\centering \small Side Menu
		\end{minipage}
	\end{tabular}
\end{center}
...
\begin{center}
	\begin{tabular}{c@{\hspace{4cm}}c}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/doctor/3.jpg}}
			\centering \small Doctor Login 
		\end{minipage} &
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/doctor/1.jpg}}
			\centering \small Doctor Page 1
		\end{minipage} \\
		\noalign{\vspace{1.7cm}}
		\begin{minipage}{0.31\textwidth}
            \fbox{\includegraphics[width=\linewidth]{images/doctor/2.jpg}}
			\centering \small Doctor Page 2
		\end{minipage}
	\end{tabular}
\end{center}
