...
\begin{table}[H]
    \begin{center}
        ...
        \multicolumn{1}{|Sc|}{\cellcolor[HTML]{C0C0C0}\textbf{Role}} & \multicolumn{1}{Sc|}{\cellcolor[HTML]{C0C0C0}\textbf{Definition}} & \multicolumn{1}{Sc|}{\cellcolor[HTML]{C0C0C0}\textbf{Main Tasks}} \\ \hline
